...
Node* templl=NULL;
Node* Node::head=templl;
Node* Node::tail=templl;
...
void deleteafter(Node*n)
{
   ...
   {   
       ...
       {
       delptr=temphead;
       temphead->nxt=temphead->nxt->nxt;
       temphead->nxt->nxt->prv=temphead;
       delete(delptr);
       }
       else
...
void deletebefore(Node*n)
{
   ...
   {   
       ...
       {
       delptr=temphead->prv;
       temphead->prv=temphead->prv->prv;
       temphead->prv->prv->nxt=temphead;
       delete(delptr);
       }
       else
       cout<<"Opps!....The item do no exist in the data set";
